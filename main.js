...
function fetchText(operationLocation) {
  ...
  .done(function(data) {
      ...
      for(let x=0; x<recognitionArray.length;x++){
        ...
        mySe.classList.add("form-select")
        let myOp = []
        ...
        myOp[2].value = 'ename';
        myOp[3].value = 'title';
        myOp[4].value = 'department';
        myOp[5].value = 'mobile';
        myOp[6].value = 'email';
        myOp[7].value = 'phone';
        myOp[8].value = 'fax';
        myOp[9].value = 'company';
        myOp[10].value = 'address';
        myOp[11].value = 'businessID';
        ...
        myOp[4].innerHTML = '部門';
        myOp[5].innerHTML = '手機';
        myOp[6].innerHTML = 'email';
        myOp[7].innerHTML = '電話';
        myOp[8].innerHTML = '傳真';
        myOp[9].innerHTML = '公司名稱';
        myOp[10].innerHTML = '公司地址 ';
        myOp[11].innerHTML = '統編';
